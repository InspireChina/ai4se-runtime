...
- **M1 PR4 签收工具（协议就绪，真实 10×A/B 未填）：** [m1-pr4-real-story-ab-playbook.md](./m1-pr4-real-story-ab-playbook.md)；`ProductionRunScorecard` + CLI `scorecard`；记分表 [m1-pr4-scorecard.csv](./m1-pr4-scorecard.csv)
