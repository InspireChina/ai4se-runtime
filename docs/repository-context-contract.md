...
> **Status:** Contract（规范）· **禁止实现代码** · 禁止改 Runtime · 禁止 Graph · 禁止继续实现 Analyzer  
> **同伴：** `requirement-analysis-contract.md` · `repository-analyzer-design.md`
...
| 项 | 值 |
|----|-----|
| 文件 | `docs/repository-context-contract.md` |
